...
async def webhook(
    ...
    # TODO: dispatch to appropriate handler based on payload topic
    return {"status": "ok"}
...
async def customers_data_erasure(request: Request):
    ...
    Shopline requires this endpoint. ImageLingo does not store customer PII,
    so we acknowledge and return OK.
    """
